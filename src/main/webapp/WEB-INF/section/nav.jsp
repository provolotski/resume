        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <sec:authorize access="hasAuthority('USER')">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" id="dropdownProfile"  aria-haspopup="true"
                           aria-expanded="false">${CURRENT_PROFILE.fullName} <span class="caret"></span></a>
                        <ul class="dropdown-menu profile-menu" aria-labelledby="dropdownProfile">

...
<div class="panel panel-info small-center-block">
    ...
    <div class="panel-body">
        <form action="/sign-in-handler" method="post">
            ...
            <div class="help-block">Вы можете использовать Ваши UID или Email или номер телефона в качестве логина</div>
            ...
            <div class="form-group">
                <label for="remember-me"><input id="remember-me" type="checkbox" value="true"> Запомнить меня </label>
            </div>
            <div class="form-group">
